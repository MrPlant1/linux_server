...
/* Define to 1 if `msg_controllen' is a member of `struct msghdr'. */
...
/* Allow SSH to use options that run local commands. */
/* #undef HAVE_UNRESTRICTED_SSH_OPTIONS */
...
#define PACKAGE_STRING "nagios-plugins 2.4.8"
